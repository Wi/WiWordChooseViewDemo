...
Pod::Spec.new do |s|
  ...
  s.name         = "WiWordChooseView"
  s.version      = "1.0.0"
  s.summary      = "A word choose view."
  ...
  s.author             = { "Wi" => "wiios@qq.com" }
  # Or just: s.author    = "Wi"
  # s.authors            = { "Wi" => "wiios@qq.com" }
  # s.social_media_url   = "http://twitter.com/Wi"
  ...
  s.source       = { :git => "https://github.com/Wi/WiWordChooseViewDemo.git", :tag => "#{s.version}" }
